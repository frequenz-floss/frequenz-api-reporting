...
class MetricSample:
    ...
    def from_pb(
        ...
        return cls(
            ...
            bounds=bounds_pb2.Bounds.from_pb(metric_sample.bounds),
        )
...
class MetricSampleVariant:
    ...
    simple_metric: SimpleMetricSample | None
    aggregated_metric: AggregatedMetricSample | None
...
class ComponentData:
    ...
    def from_pb(
        ...
        return cls(
            ...
            metric=MetricSample.from_pb(component_data.metric_sample),
            states=ComponentState.from_pb(component_data.states),
        )
...
class ComponentState:
    ...
    warnings: List[ComponentStateCode]
    ...
    def from_pb(
        ...
        return cls(
            ...
            warnings=[
                ComponentStateCode.from_pb(warning)
    ...
    def to_pb(self) -> microgrid_components_components_pb2.ComponentState:
        ...
        return microgrid_components_components_pb2.ComponentState(
            sampled_at=timestamp_pb2.Timestamp().FromDatetime(self.sampled_at),
            states=[state.to_pb() for state in self.states],
            warnings=[warning.to_pb() for warning in self.warnings],
            errors=[error.to_pb() for error in self.errors],
        )
...
class MicrogridData:
    ...
    def to_pb(self) -> reporting_pb2.MicrogridData:
        ...
        return reporting_pb2.MicrogridData(
            microgrid_id=self.microgrid_id,
            components=[component.to_pb() for component in self.components],
        )
