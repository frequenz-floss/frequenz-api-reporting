# Contributing to Frequenz Reporting API
...
5. A GitHub action will test the tag and if all goes well it will create
   a [GitHub
   Release](https://github.com/frequenz-floss/frequenz-api-reporting/releases),
   and upload a new package to
   [PyPI](https://pypi.org/project/frequenz-api-reporting/)
   automatically.
